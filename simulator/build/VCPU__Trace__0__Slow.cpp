...
VL_ATTR_COLD void VCPU___024root__trace_full_sub_0(VCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    VL_SHIFTR_WWI(128,128,7, __Vtemp_12, __Vtemp_11, 
                  (0x60U & (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                            << 3U)));
    bufp->fullWData(oldp+210,(__Vtemp_12),128);
    ...
    bufp->fullWData(oldp+214,(__Vtemp_17),128);
    ...
    bufp->fullWData(oldp+222,(__Vtemp_18),128);
    ...
    bufp->fullWData(oldp+292,(__Vtemp_19),128);
    ...
    bufp->fullWData(oldp+454,(__Vtemp_23),128);
    ...
    bufp->fullWData(oldp+524,(__Vtemp_24),128);
