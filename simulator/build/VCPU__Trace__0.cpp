...
void VCPU___024root__trace_chg_sub_0(VCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        VL_SHIFTR_WWI(128,128,7, __Vtemp_12, __Vtemp_11, 
                      (0x60U & (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                                << 3U)));
        bufp->chgWData(oldp+209,(__Vtemp_12),128);
        ...
        bufp->chgWData(oldp+213,(__Vtemp_17),128);
        ...
        bufp->chgWData(oldp+221,(__Vtemp_18),128);
        ...
        bufp->chgWData(oldp+291,(__Vtemp_19),128);
        ...
        bufp->chgWData(oldp+453,(__Vtemp_23),128);
        ...
        bufp->chgWData(oldp+523,(__Vtemp_24),128);
