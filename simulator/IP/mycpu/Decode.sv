...
module Decode(
    ...
    assign priv_vec[`BAD_PC] = pc_id[1:0] != 2'b00;
    assign priv_vec[`EBREAK] = inst == 32'h100073;
    assign priv_vec[`PC_FAULT] = pc_id >32'h81000000;
endmodule
